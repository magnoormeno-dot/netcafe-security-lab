...
This subproject contains the defensive baseline for internet cafes, gaming venues, esports hotels, and shared-PC environments. The controls are global in scope. Public examples use a region-neutral venue model with Windows client PCs, one or more billing servers, cashier or reception workstations, restoration software, and a mixed wired/wireless network.
...
This project does not provide exploit instructions, bypass tools, or vendor-specific vulnerability claims. It also does not replace legal, insurance, or regulatory advice for any jurisdiction.
